...
function getfile(){
  ...
  <div class="row">
    ...
    <h3 style="color:#9c2129;" >Ajouter un artiste</h3>
      ...
      <div class="form-group">
        <label for="inputMdp">Lien Instagram</label>
        <input type="url" class="form-control" id="inputMdp" placeholder="https://instagram.com/pseudo" name="mdp">
      </div>   
      <div class="form-group">
